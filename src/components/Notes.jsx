...
setData(newArray)
  ...
  <Card style={{ width: '18rem' }}>
      <Card.Body>
        <Card.Title>FeedBacks  <i className="fa-solid fa-pen p-3" style={{color: "#19191a;"}}></i><i className="fa-solid fa-trash-can"onClick={()=>handleDelete(index)} style={{color: "#111212;"}}></i></Card.Title>
